...
import eu.faircode.xlua.x.hook.interceptors.cell.SubFieldPair;
...
public class SubscriptionInfoStub {
    ...
    public static final List<SubFieldPair> FIELDS = Arrays.asList(
            SubFieldPair.create("mId", "cell.sim.device.id"),   //Once inserted, it uses that number, so like port index but not, as it will start on (1) and increments for each new SIM
            SubFieldPair.create("mIccId", "cell.sim.icc.id"),
            SubFieldPair.create("mSimSlotIndex", "cell.sim.slot.index"),    //Index where it is inserted, 0 SIM slot, actual Slot
            SubFieldPair.create("mDisplayName", "cell.sim.display.name"),   //Usually the Carrier Name
            SubFieldPair.create("mCarrierName", "cell.sim.carrier.name"),   //Can at times display "No Service"
            SubFieldPair.create("mDisplayNameSource", "cell.sim.display.name.source"),
            SubFieldPair.create("mIconTint", "cell.sim.carrier.icon.tint"),
            SubFieldPair.create("mNumber", "cell.sim.phone.number"),
            SubFieldPair.create("mDataRoaming", "cell.sim.is.roaming"),
            SubFieldPair.create("mMcc", "cell.sim.carrier.mcc"),
            SubFieldPair.create("mMnc", "cell.sim.carrier.mnc"),
            SubFieldPair.create("mEhplmns", "cell.sim.carrier.ehplmns"),
            SubFieldPair.create("mHplmns", "cell.sim.carrier.hplmns"),
            SubFieldPair.create("mIsEmbedded", "cell.sim.is.e.sim"),
            SubFieldPair.create("mCardString"),
            SubFieldPair.create("mNativeAccessRules", "cell.sim.carrier.native.access.rules"),
            SubFieldPair.create("mCarrierConfigAccessRules", "cell.sim.carrier.config.access.rules"),   //It is a list of Allowed Apps on the Device to talk talk to SIM Card, Cert Signed from App and Package name like "com.tmobile.pr.mytmobile"
            SubFieldPair.create("mIsOpportunistic", "cell.sim.carrier.is.opportunistic"),
            SubFieldPair.create("mGroupUuid"),
            SubFieldPair.create("mCountryIso", "cell.sim.carrier.country.iso"),
            SubFieldPair.create("mCarrierId", "cell.sim.carrier.id"),   //carrierIdentification.db -> carrier_id [_id]
            SubFieldPair.create("mProfileClass", "cell.sim.profile.class"), //-1 ?
            SubFieldPair.create("mType", "cell.sim.type"),  //0/LOCAL_SIM
            SubFieldPair.create("mGroupOwner"),
            SubFieldPair.create("mAreUiccApplicationsEnabled", "cell.sim.uicc.applications.enabled"),   //true
            SubFieldPair.create("mPortIndex", "cell.sim.port.index"),   //Port Index of the Uicc Card Usually (0) not related to Sim Slot Index
            SubFieldPair.create("mUsageSetting", "cell.sim.usage.setting"), //DEFAULT
            SubFieldPair.create("mTransferStatus"),
            SubFieldPair.create("mIconBitmap"),
            SubFieldPair.create("mCardId", "cell.sim.card.id"),
            SubFieldPair.create("mIsGroupDisabled", "cell.sim.group.disabled"), //false
            SubFieldPair.create("mIsOnlyNonTerrestrialNetwork"),
            SubFieldPair.create("mServiceCapabilities")
    );
