...
public class GlobalZoneUtil {
    ...
    public static final String[] TIMEZONE_ISO_CODES = {
            "UM", // Pacific/Midway
            "US", // America/Adak
            "US", // Pacific/Honolulu
    ...
    public static final String[] TIMEZONE_LANGUAGE_TAGS = {
    ...
    public static final String[] TIMEZONE_LANGUAGE_ISO = {
