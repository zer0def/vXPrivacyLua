...
/*public class DataSIMTypeElement implements ISpinnerElement {
    public static DataSIMTypeElement create(String name, Integer value) { return new DataSIMTypeElement(name, value); }
    private String displayName;
    private Integer value;

    public DataSIMTypeElement() { }
    public DataSIMTypeElement(String name, Integer value) {
