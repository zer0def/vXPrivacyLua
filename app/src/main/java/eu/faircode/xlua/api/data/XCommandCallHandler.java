...
/*public abstract class XCommandCallHandler {
    public String name;
    public String parent;
    public boolean requiresPermissionCheck;

    public XCommandCallHandler() { }
    public XCommandCallHandler(String name, boolean requirePermissionCheck) {
        this.name = name;
        this.requiresPermissionCheck = requirePermissionCheck;
    }

    public abstract Bundle handle(XCallData rawData) throws Throwable;
